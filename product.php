			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div id="myCarousel" class="carousel slide" data-ride="carousel" style="height: 400px">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active"><img style="height: 400px; display: block; margin: 0 auto" src="images/<?= $image ?>" alt="Test"></div>
						<div class="item"><img style="height: 400px; display: block; margin: 0 auto" src="images/<?= $image ?>" alt="Test"></div>
						<div class="item"><img style="height: 400px; display: block; margin: 0 auto" src="images/<?= $image ?>" alt="Test"></div>
						<div class="item"><img style="height: 400px; display: block; margin: 0 auto" src="images/<?= $image ?>" alt="Test"></div>
					</div>
